...
use Negromovich\LatLonCalculator\LatLon;
...
class HgtReader {
	 ...
	 * @throws \Exception
	 */
	public static function getElevation($lat, $lon = null, &$fName = null) {
		...
		if ($Xn<=$a1 && $Yn <= $a2){
			...
			$c1=$a1;
			$c2=$a2+1;
		}else throw new \Exception("{$Xn}:{$Yn}");
